...
PROCEDURE Sign(sig: ADDRESS; msg: REFANY; len: C.unsigned_int; pub, prv: ADDRESS; );

<* EXTERNAL ed25519_verify *>
PROCEDURE Verify(sig: ADDRESS; msg: REFANY; len: C.unsigned_int; pub: ADDRESS; ) : BOOLEAN;
